...
var Company = /** @class */ (function (_super) {
    ...
    function Company(name, contact, address, single, compname, compgst, compstate) {
        ...
        _this.gstnumbar = compgst;
        _this.state = compstate;
        return _this;
    }
    Company.prototype.personDetails = function () {
        console.log("companyname:".concat(this.cname, " name:").concat(this.pname, " contact:").concat(this.pcontact, " gstnumber:").concat(this.gstnumbar, " state:").concat(this.state));
    };
    return Company;
}(oops_1.default));
var compObj = new Company("vijay", 777, "kerala", true, "changepond", 12364, "tamilnadu");
